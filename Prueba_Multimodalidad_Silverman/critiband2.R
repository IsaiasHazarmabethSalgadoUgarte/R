...
#Revised: 28/04/2021; 26/03/2023; 16/03/2025
#Authors: I.H. Salgado-Ugarte & V.M. Saito-Quezada
critiband2 <- function(y, bwh, bwl, st, m, list="FALSE", plot="TRUE") {
...
if (list=="TRUE") cat("Estimation number ","  Bandwidth ", "  Number of modes ","\n")
