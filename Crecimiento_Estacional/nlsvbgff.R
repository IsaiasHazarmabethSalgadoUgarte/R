...
#according to the proposal by Pitcher & MacDonald (1973) & Haddon (2001)
#Authors: Isaías H. Salgado-Ugarte & V. Mitsui Saito-Quezada
#R version by Leonardo Chacón Ramírez & Alan García Martínez
#Date: 31/01/2021; update: 30/03/2024
nlsvbgff <- function(ml,age,at1,at2,at3,at4,at5){
  ...
  model <- nls(ml ~ Li * (1 - exp(-1 * ((C*sin(2*pi*(age-s)/52))+(K*(age-t0))))),start = st)
