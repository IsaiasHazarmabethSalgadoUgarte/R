...
bandw3 <- function(x, kernel="Gaussian", ...) {
...
cat("Sturges' number of bins                           = ", trunc(ks,4),"\n")
cat("Dixon & Kronmal number of lines                   = ", trunc(st,4),"\n")
cat("Oversmoothed number of bins                      <= ", trunc(osb,4),"\n")
cat("------------------------------------------------------------","\n")
cat("FP oversmoothed number of bins                   <= ", trunc(fposb,4),"\n")
cat("============================================================","\n")
...
cat("============================================================","\n")
if(kernel=="Uniform") cat("Uniform kernel","\n") else

if(kernel=="Triangular") cat("Triangular kernel","\n") else

if(kernel=="Epanechnikov") cat("Epanechnikov kernel","\n") else

if(kernel=="Biweight") cat("Biweight kernel","\n") else

if(kernel=="Triweight") cat("Triweight kernel","\n") else

if(kernel=="Gaussian") cat("Gaussian kernel","\n") else
